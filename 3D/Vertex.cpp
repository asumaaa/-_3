...
void Ver3::Initialize(XMFLOAT3 size)
{
	...
	for (int i = 0; i < fineSize * fineSize * 4; i++)
	{
		if (i % 4 == 0)
		{
			x = cos(((float)(i / 4) / fineSize * PI * 2));
			z = sin(((float)(i / 4) / fineSize * PI * 2));
			v[i] = { {x , 0, z}, {}, {0.0f,1.0f} };
		}
		if (i % 4 == 1)
		{
			x = cos(((float)(i / 4) / fineSize * PI * 2) / fineSize);
			z = sin(((float)(i / 4) / fineSize * PI * 2) / fineSize);
			v[i] = { { x, 0, z}, {}, {0.0f,0.0f} };
		}
		if (i % 4 == 2)
		{
			x = cos(((float)(i / 4 + 1) / fineSize * PI * 2) / fineSize);
			z = sin(((float)(i / 4 + 1) / fineSize * PI * 2) / fineSize);
			v[i] = { { x, 5, z}, {}, {1.0f,1.0f} };
		}
		if (i % 4 == 3)
		{
			x = cos(((float)(i / 4 + 1) * PI * 2) / fineSize);
			z = sin(((float)(i / 4 + 1) * PI * 2) / fineSize);
			v[i] = { { x, 5, z}, {}, {1.0f,0.0f} };
		}

		/*if (i % 4 == 0)
		{
			x = cos(((float)(i / 4) / fineSize * PI * 2)) * sin(((float)(i / (fineSize * 4)) / fineSize * PI * 2)) * size.x;
			y = cos(((float)(i / (fineSize * 4)) / fineSize * PI * 2)) * size.z;
			z = sin(((float)(i / 4) / fineSize * PI * 2)) * sin(((float)(i / (fineSize * 4)) / fineSize * PI * 2)) * size.y;
			v[i] = { {x , y, z}, {}, {0.0f,1.0f} };
		}
		if (i % 4 == 1)
		{
			x = cos(((float)(i / 4) / fineSize * PI * 2) / fineSize) * sin(((float)(i / (fineSize * 4)) / fineSize * PI * 2)) * size.x;
			y = cos(((float)(i / (fineSize * 4) + 1) / fineSize * PI * 2)) * size.z;
			z = sin(((float)(i / 4) / fineSize * PI * 2) / fineSize) * sin(((float)(i / (fineSize * 4)) / fineSize * PI * 2)) * size.y;
			v[i] = { { x, y, z}, {}, {0.0f,0.0f} };
		}
		if (i % 4 == 2)
		{
			x = cos(((float)(i / 4 + 1) / fineSize * PI * 2) / fineSize) * sin(((float)(i / (fineSize * 4) + 1) / fineSize * PI * 2)) * size.x;
			y = cos(((float)(i / (fineSize * 4)) / fineSize * PI * 2)) * size.z;
			z = sin(((float)(i / 4 + 1) / fineSize * PI * 2) / fineSize) * sin(((float)(i / (fineSize * 4) + 1) / fineSize * PI * 2)) * size.y;
			v[i] = { { x, y, z}, {}, {1.0f,1.0f} };
		}
		if (i % 4 == 3)
		{
			x = cos(((float)(i / 4 + 1) * PI * 2) / fineSize) * sin(((float)(i / (fineSize * 4) + 1) / fineSize * PI * 2)) * size.x;
			y = cos(((float)(i / (fineSize * 4) + 1) / fineSize * PI * 2)) * size.z;
			z = sin(((float)(i / 4 + 1) * PI * 2) / fineSize) * sin(((float)(i / (fineSize * 4) + 1) / fineSize * PI * 2)) * size.y;
			v[i] = { { x, y, z}, {}, {1.0f,0.0f} };
		}*/
	}
